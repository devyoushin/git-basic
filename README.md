...
1. `docs/basics/`에서 Git 저장소, stage, commit, branch, remote 기본기 학습
2. `docs/workflow/`에서 merge, rebase, stash, cherry-pick 학습
3. `docs/history/`에서 log, diff, blame, bisect, reset/revert 학습
4. `docs/collaboration/`, `docs/troubleshooting/`에서 협업과 복구 패턴 학습
